...
const room_tiles = [
    ...
    new Tile(15, 'abyss', 'abyss', true, true, true, false, false, false, 'abyss'),//Пропасть
    ...
    new Tile(46, 'abyss', 'abyss', true, true, true, false, false, false, 'abyss'),//Пропасть
    new Tile(47, true, 'abyss', 'abyss', true, true, false, false, false, 'abyss'),//Пропасть
    new Tile(48, true, 'abyss', 'abyss', true, true, false, false, false, 'abyss'),//Пропасть
    ...
    new Tile(72, false, true, true, true, false, false, false, false, 'corridor'), 
    new Tile(73, false, true, false, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(77, false, true, true, true, false, false, false, false, 'corridor'), 
    new Tile(78, false, true, false, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(82, true, false, true, true, false, false, false, false, 'corridor'), 
    new Tile(83, false, false, true, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(87, true, false, true, true, false, false, false, false, 'corridor'), 
    new Tile(88, false, false, true, true, false, false, false, false, 'corridor'), 
    new Tile(89, false, false, true, true, true, true, false, false, false), 
    new Tile(90, true, true, true, true, true, true, false, false, false), 
    
    new Tile(91, true, true, false, true, false, false, false, false, 'corridor'), 
    new Tile(92, true, false, false, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(96, true, true, false, true, false, false, false, false, 'corridor'), 
    new Tile(97, true, false, false, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(101, true, true, true, true, false, false, false, false, 'corridor'), 
    new Tile(102, true, true, true, true, false, false, false, false, 'corridor'), 
    ...
    new Tile(126, true, 'abyss', 'abyss', true, true, false, false, false, 'abyss'),//Пропасть
