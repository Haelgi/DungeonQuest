...
const dragon_cards = [
    new Card(1, 'Дракон Спит', ()=>{return /*Тяните 2 Карты Сокровищ. В свой следующий ход Вы можете либо покинуть Сокровищницу, либо остаться и вытянуть еще одну Карту Дракона.*/}),
    new Card(1, 'Дракон Спит', ()=>{return /*Тяните 2 Карты Сокровищ. В свой следующий ход Вы можете либо покинуть Сокровищницу, либо остаться и вытянуть еще одну Карту Дракона.*/}),
    new Card(1, 'Дракон Спит', ()=>{return /*Тяните 2 Карты Сокровищ. В свой следующий ход Вы можете либо покинуть Сокровищницу, либо остаться и вытянуть еще одну Карту Дракона.*/}),
    new Card(1, 'Дракон Спит', ()=>{return /*Тяните 2 Карты Сокровищ. В свой следующий ход Вы можете либо покинуть Сокровищницу, либо остаться и вытянуть еще одну Карту Дракона.*/}),
    new Card(1, 'Дракон Спит', ()=>{return /*Тяните 2 Карты Сокровищ. В свой следующий ход Вы можете либо покинуть Сокровищницу, либо остаться и вытянуть еще одну Карту Дракона.*/}),
