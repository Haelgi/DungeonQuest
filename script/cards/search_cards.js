...
const search_cards = [
    ...
    /*20*/new Card(5, 'Отмычка', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Обыскивая комнату, Вы нашли замаскированную под кольцо отмычку. Сбросьте эту карту вместо того, чтобы тянуть Карту Двери; дверь открывается. */}),
    /*21*/new Card(5, 'Отмычка', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Обыскивая комнату, Вы нашли замаскированную под кольцо отмычку. Сбросьте эту карту вместо того, чтобы тянуть Карту Двери; дверь открывается. */}),
