...
const search_cards = [
    ...
    /*8*/new Card(2, 'Зелье Лечения', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 3 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +250 золота*/}),
    /*9*/new Card(2, 'Зелье Лечения', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 3 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +250 золота*/}),
    /*10*/new Card(2, 'Зелье Лечения', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 3 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +250 золота*/}),
    /*11*/new Card(2, 'Зелье Лечения', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 3 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +250 золота*/}),
    /*12*/new Card(2, 'Зелье Лечения', 'treasure', false, ()=>{ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 3 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +250 золота*/}),
