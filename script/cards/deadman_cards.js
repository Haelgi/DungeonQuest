...
const deadman_cards = [
    ...
    /*6*/new Card(3, 'Малое Зелье Лечения', 'treasure', 150, ()=>{ ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 2 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +150 золота*/}),
    /*7*/new Card(3, 'Малое Зелье Лечения', 'treasure', 150, ()=>{ ew.removeAllEW() /* "трофей" Во время своего хода, Вы можете сбросить эту карту, исцелив при этом 2 ранения Вашего героя. Вы не можете использовать эту карту после смерти своего героя. +150 золота*/}),
    ...
    /*9*/new Card(5, 'Свиток Света', 'treasure', false, ()=>{ ew.removeAllEW() /* "трофей" Вы нашли у мертвеца свиток света. Находясь в Катакомбах, Вы можете сбросить эту карту в начале своего хода и взять три Карты Катакомб вместо одной, после чего выбрать и разыграть одну из них, а остальные две сбросить.*/}),
    /*10*/new Card(6, 'Проклятие Мертвеца', 'event', false, ()=>{ew.removeAllEW(); /* Потревожив останки, Вы стали жертвой проклятия. Вы чувствуете потерю жизненной силы. Получите 2 ранения и сбросьте 1 жетон решимости (если есть).*/}),
