...
player.treasureCardContainer = [treasure_cards[3], treasure_cards[4], treasure_cards[1], treasure_cards[1], treasure_cards[1], treasure_cards[1]];
...
export function game_container() {
    // game.drawFieldTileTests(126, 90, 1,  0);
